...
class MessageArray : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto3_proto_example.MessageArray) */ {
 public:
  MessageArray();
  ...
  // @@protoc_insertion_point(class_scope:proto3_proto_example.MessageArray)
 private:
