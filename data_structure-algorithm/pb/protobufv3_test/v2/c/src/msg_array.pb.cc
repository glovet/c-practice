...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MessageArray, _has_bits_),
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::proto2_proto::protobuf_msg_2eproto::InitDefaults();
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\017msg_array.proto\022\024proto2_proto_example\032"
      "\tmsg.proto\"\225\001\n\014MessageArray\022\?\n\007msg_map\030\001"
      " \003(\0132..proto2_proto_example.MessageArray"
      ".MsgMapEntry\032D\n\013MsgMapEntry\022\013\n\003key\030\001 \001(\t"
      "\022$\n\005value\030\002 \001(\0132\025.proto2_proto.Message:\002"
      "8\001"
  };
  ...
  ::proto2_proto::protobuf_msg_2eproto::AddDescriptors();
}
} // anonymous namespace
...
MessageArray::MessageArray()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:proto2_proto_example.MessageArray)
}
MessageArray::MessageArray(const MessageArray& from)
  ...
  // @@protoc_insertion_point(copy_constructor:proto2_proto_example.MessageArray)
}
...
MessageArray::~MessageArray() {
  // @@protoc_insertion_point(destructor:proto2_proto_example.MessageArray)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:proto2_proto_example.MessageArray)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:proto2_proto_example.MessageArray)
  for (;;) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          MessageArray_MsgMapEntry::Parser< ::google::protobuf::internal::MapField<
              ...
              0 >,
            ::google::protobuf::Map< ::std::string, ::proto2_proto::Message > > parser(&msg_map_);
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
              input, &parser));
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            parser.key().data(), static_cast<int>(parser.key().length()),
            ::google::protobuf::internal::WireFormat::PARSE,
            "proto2_proto_example.MessageArray.MsgMapEntry.key");
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:proto2_proto_example.MessageArray)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:proto2_proto_example.MessageArray)
  return false;
#undef DO_
}
...
void MessageArray::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:proto2_proto_example.MessageArray)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  // map<string, .proto2_proto.Message> msg_map = 1;
  if (!this->msg_map().empty()) {
    typedef ::google::protobuf::Map< ::std::string, ::proto2_proto::Message >::const_pointer
        ConstPtr;
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      typedef ::google::protobuf::Map< ::std::string, ::proto2_proto::Message >::size_type size_type;
      size_type n = 0;
      for (::google::protobuf::Map< ::std::string, ::proto2_proto::Message >::const_iterator
  ...
  // @@protoc_insertion_point(serialize_end:proto2_proto_example.MessageArray)
}

::google::protobuf::uint8* MessageArray::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:proto2_proto_example.MessageArray)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:proto2_proto_example.MessageArray)
  return target;
}

size_t MessageArray::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:proto2_proto_example.MessageArray)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:proto2_proto_example.MessageArray)
  GOOGLE_DCHECK_NE(&from, this);
  const MessageArray* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const MessageArray>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:proto2_proto_example.MessageArray)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:proto2_proto_example.MessageArray)
    MergeFrom(*source);
  }
}

void MessageArray::MergeFrom(const MessageArray& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:proto2_proto_example.MessageArray)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:proto2_proto_example.MessageArray)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:proto2_proto_example.MessageArray)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
