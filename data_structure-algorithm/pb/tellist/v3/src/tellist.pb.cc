...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "um_list\022\017\n\007tel_num\030\001 \003(\004b\006proto3"
  };
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitiveNoInline<
                   ::google::protobuf::uint64, ::google::protobuf::internal::WireFormatLite::TYPE_UINT64>(
                 1, 10u, input, this->mutable_tel_num())));
        } else {
          goto handle_unusual;
        }
        break;
  ...
  if (this->tel_num_size() > 0) {
    ...
    target = ::google::protobuf::io::CodedOutputStream::WriteVarint32ToArray(
        static_cast< ::google::protobuf::uint32>(
            _tel_num_cached_byte_size_), target);
    target = ::google::protobuf::internal::WireFormatLite::
      WriteUInt64NoTagToArray(this->tel_num_, target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:ikurento.hi.hi_tel_num_list)
  ...
  // repeated uint64 tel_num = 1;
  {
    ...
    GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
    _tel_num_cached_byte_size_ = cached_size;
    GOOGLE_SAFE_CONCURRENT_WRITES_END();
