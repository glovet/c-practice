 ...
 *  Project:    cstl
 *  Module:     allocate
 *  Filename:   cstl_alloc.h
 *      
 *  Declaration allocator for cstl, manage the memory for cstl, the default
 *  model use memory pool, and the user model use tradition malloc, free 
 *  function. 
 *
 *  2008-11-24 19:24:33
 * =============================================================================
